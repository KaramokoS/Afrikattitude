...
class OwnerEditCourseMixin(OwnerEditMixin, OwnerCourseMixin):
    fields = ['subject', 'title', 'slug', 'overview']
    success_url = reverse_lazy('course:manage_course_list')
...
class CourseCreateView(PermissionRequiredMixin, OwnerEditCourseMixin, CreateView):
    permission_required = 'courses.add_course'

class CourseUpdateView(PermissionRequiredMixin, OwnerEditCourseMixin, UpdateView):
